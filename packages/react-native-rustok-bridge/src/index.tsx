...
import installer from './NativeRustokBridge';
...
export * from './generated/rustok_mobile_bindings';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as rustok_mobile_bindings from './generated/rustok_mobile_bindings';
...
if (!initialized) {
  rustok_mobile_bindings.default.initialize();
  initialized = true;
}
