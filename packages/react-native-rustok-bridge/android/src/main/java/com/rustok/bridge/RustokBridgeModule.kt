...
@ReactModule(name = RustokBridgeModule.NAME)
class RustokBridgeModule(reactContext: ReactApplicationContext) :
  NativeRustokBridgeSpec(reactContext) {
  ...
  // react-native-rustok-bridge.cpp
  ...
  companion object {
    const val NAME = "RustokBridge"

    init {
      System.loadLibrary("react-native-rustok-bridge")
    }
  }
}